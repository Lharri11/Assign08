...
(declare parse-if-statement)
(declare parse-while-statement)
...
;   token-seq - the input token sequence
;
; Returns: a SingleParseResult with the :if_statement parse node
; and the remaining input token sequence.
;
...
;   token-seq - the input token sequence
;
; Returns: a SingleParseResult with the :while_statement parse node
; and the remaining input token sequence.
;
